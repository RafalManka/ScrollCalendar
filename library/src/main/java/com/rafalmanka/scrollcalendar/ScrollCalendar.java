...
<<<<<<< Updated upstream:library/src/main/java/com/rafalmanka/scrollcalendar/ScrollCalendar.java
        post(new Runnable() {
            @Override
            public void run() {
...
>>>>>>> Stashed changes:scrollcalendar/src/main/java/pl/rafalmanka/scrollcalendar/ScrollCalendar.java
    }
